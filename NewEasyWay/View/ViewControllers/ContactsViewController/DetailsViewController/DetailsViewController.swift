...
final class DetailsViewController: UIViewController {
    ...
    private lazy var officeTitleLabel: UILabel = {
        let label = UILabel()
    ...
    private lazy var officeTextView: UITextView = {
    ...
    private lazy var warehouseTitleLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont(name: "Yeseva One", size: 20)
        label.backgroundColor = .systemGray6
        label.textAlignment = .center
    ...
    private lazy var warehouseTextView: UITextView = {
        let textView = UITextView()
        textView.isEditable = false
        textView.textColor = .systemGray
        return textView
